...
class ContinentDTOTest
{
    ...
    class ValidationGroup
    {
        ...
        {
            final ContinentDTO itemUnderTest = new ContinentDTO( null,
                                                                 "CC",
                                                                 "Name",
                                                                 testURI,
                                                                 "Key1, key2" );
            final Set<ConstraintViolation<ContinentDTO>> constraintViolations = validator.validate( itemUnderTest );
        ...
        {
            final ContinentDTO itemUnderTest = new ContinentDTO( 1,
                                                                 "  ",
                                                                 "Name",
                                                                 testURI,
                                                                 "Key1, key2" );
